...
<div class="main">
	...
	<div class="content">
		...
		<form class="info" id="person-info" action="registerOfStudent2.action" method="post" enctype="multipart/form-data">
				...
				<div class="info-table">
					<div class="info-line">
						<div class="info-other">
							<div class="info-line">
								...
								<div class="info-input-box">
									<input type="text" class="info-input" name="userName">
								</div>
							</div>
							<div class="info-line">
						...
						<div class="info-avatar">
							...
							<input type="file" name="headPortrait" type="file" onchange="previewImage(this)" id="headPortrait">
					...
					<div class="info-st-line info-st-line-wechat">
						...
						<div class="info-st-line-right">
							<div class="info-check-box">
								<div class="info-checkbox-box">
									<div class="info-check-icon info-check-icon-active">
										<input type="radio" name="country" value="1" checked>
									</div>
					...
					<div class="info-st-line info-st-location">
						...
						<div class="info-st-line-right info-st-line-map">
							<div class="info-st-right-up-up">
								<input id="suggestId" type="text" class="info-st-location" name="location">
							</div>
			...
			<input type="text" id="coordinate" name="userCoordinate" style="display: none"/>
