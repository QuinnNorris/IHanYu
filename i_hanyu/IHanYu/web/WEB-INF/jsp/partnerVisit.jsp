...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/partnerVisit.css">
</head>
<body>
<div class="main">
            ...
            <div class="header-frame">
                ...
                <div class="avatar-info">
                    ...
                    <div class="avatar-info-right">
                        <div class="username"><s:property value="partner.userName()"></s:property></div>
                    </div>
                </div>
            ...
            <div class="content-frame">
                <div class="left-frame">
                    <div class="card person">
                        ...
                        <div class="card-content">
                            <div class="card-item">
                                <div class="card-item-c">姓名：<s:property value="partner.userName()"></s:property></div>
                                <div class="card-item-e">name： <s:property value="partner.userName()"></s:property></div>
                            </div>
                            <div class="card-item">
                                <div class="card-item-c">学校：<s:property value="partner.university"></s:property></div>
                                <div class="card-item-e">school：<s:property value="partner.university"></s:property></div>
                            </div>
                            <div class="card-item">
                                <div class="card-item-c">母语：<s:property value="partner.getMotherLanguage().getLanguage_c()"></s:property> </div>
                                <div class="card-item-e">I speak：<s:property value="partner.getMotherLanguage().getLanguage_e()"></s:property></div>
                            </div>
                            <div class="card-item">
                                <div class="card-item-c">学习：<s:property value="partner.getPartnerLanguage().getLanguage_c()"></s:property></div>
                                <div class="card-item-e">I study：<s:property value="partner.getPartnerLanguage().getLanguage_e()"></s:property></div>
                            </div>
                            <div class="card-item">
                                <div class="card-item-c">性别：<s:property value="partner.userSex_c()"></s:property></div>
                                <div class="card-item-e">gender：<s:property value="partner.userSex_e()"></s:property></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="right-frame">
                    ...
                    <div class="card intro-self">
                        ...
                        <div class="card-content">
                            <div class="card-item">
                                <div class="card-item-c"><s:property value="partner.getSelfIntro()"></s:property></div>
...
<script type="text/javascript" src="./js/partnerVisit.js"></script>
<script>
    $(document).ready(function(){
        $(".avatar").css({'background':'url(<s:property value="partner.userAvatar()"></s:property>) center center no-repeat','background-size':'90% 90%'});
    });
    var lng=${partner.lng};
    var lat=${partner.lat};
</script>
