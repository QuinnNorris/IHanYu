...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/teacherVisit.css">
</head>
<body>
<div class="main">
			...
			<div class="header-frame">
				...
				<div class="avatar-info">
					...
					<div class="avatar-info-right">
						<div class="username"><s:property value="teacher.userName()"></s:property></div>
					</div>
				</div>
			...
			<div class="content-frame">
				<div class="left-frame">
					<div class="card person">
						...
						<div class="card-content">
							<div class="card-item">
								<div class="card-item-c">姓名：<s:property value="teacher.userName()"></s:property></div>
								<div class="card-item-e">name： <s:property value="teacher.userName()"></s:property></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">
									我擅长于：<s:iterator value="teacher.getGoodAt()" id="tg"><s:property value="#tg.getZh()"></s:property>&nbsp;</s:iterator>
								</div>
								<div class="card-item-e">I'm good At：<s:iterator value="teacher.getGoodAt()" id="tg"><s:property value="#tg.getEn()"></s:property>&nbsp;</s:iterator></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">授课时间：<s:iterator value="teacher.getClassTime()" id="tc"><s:property value="#tc.getName()"></s:property>&nbsp;</s:iterator>
								</div>
								<div class="card-item-e">Class Name：<s:iterator value="teacher.getClassTime()" id="tc"><s:property value="#tc.getName()"></s:property>&nbsp;</s:iterator></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">手机：<s:property value="teacher.getPhoneNumber()"></s:property></div>
								<div class="card-item-e">Tel：<s:property value="teacher.getPhoneNumber()"></s:property></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">课酬：<s:property value="teacher.getPayment()"></s:property></div>
								<div class="card-item-e">payment：<s:property value="teacher.getPayment()"></s:property></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">地点：<s:property value="teacher.getLocation()"></s:property></div>
								<div class="card-item-e">location：<s:property value="teacher.getLocation()"></s:property></div>
							</div>
						</div>
					</div>
				...
				<div class="right-frame">
					...
					<div class="card intro-self">
						...
						<div class="card-content">
							<div class="card-item">
								<div class="card-item-c"><s:property value="teacher.getTeachingStyle()"></s:property> </div>
					...
					<div class="card intro-self">
						...
						<div class="card-content">
							<div class="card-item">
								<div class="card-item-c"><s:property value="teacher.getTeachingExperience()"></s:property> </div>
								<div class="card-item-e"></div>
							</div>
						</div>
					</div>
...
<script type="text/javascript" src="./js/teacherVisit.js"></script>
<script>
    $(document).ready(function(){
        $(".avatar").css({'background':'url(<s:property value="teacher.userAvatar()"></s:property>) center center no-repeat','background-size':'90% 90%'});
    });
    var lng=${teacher.lng};
    var lat=${teacher.lat};
</script>
