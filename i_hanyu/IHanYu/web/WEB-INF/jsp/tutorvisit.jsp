			...
			<div class="header-frame">
				...
				<div class="avatar-info">
					...
					<div class="avatar-info-right">
						<div class="username"><s:property value="student.userName()"></s:property></div>
					</div>
				</div>
				...
				<div class="left-frame">
					<div class="card person">
						...
						<div class="card-content">
							<div class="card-item">
								<div class="card-item-c">用户名：<s:property value="student.userName()"></s:property></div>
								<div class="card-item-e">username：<s:property value="student.userName()"></s:property></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">微信：<s:property value="student.phoneNumber"></s:property></div>
								<div class="card-item-e">Wechat：<s:property value="student.phoneNumber"></s:property></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">国家：<s:property value="student.getCountry().ch()"></s:property> </div>
								<div class="card-item-e">country：<s:property value="student.getCountry().en()"></s:property></div>
							</div>
						</div>
					</div>
...
<script>
    $(document).ready(function(){
        $(".avatar").css({'background':'url(<s:property value="student.userAvatar()"></s:property>) center center no-repeat','background-size':'90% 90%'});
    });
    var lng=${student.lng};
    var lat=${student.lat};
</script>
